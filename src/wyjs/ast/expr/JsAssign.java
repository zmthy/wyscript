...
public class JsAssign implements JsExpr {
  ...
  public static interface JsAssignable extends JsExpr {
    ...
    /**
     * If the value is a local variable, this method must return the name of the
     * variable in order to have its scope correctly set with a <code>var</code>
     * statement. If not, it should return null.
     * 
