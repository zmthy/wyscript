...
public interface UnresolvedType extends SyntacticElement {
  ...
  public static final class Any extends SyntacticElement.Impl implements
      NonUnion {
  ...
  public static final class Existential extends SyntacticElement.Impl implements
      NonUnion {
  ...
  public static final class Int extends SyntacticElement.Impl implements
      NonUnion {
  ...
  public static final class Set extends SyntacticElement.Impl implements
      NonUnion {
  ...
  public static final class Dictionary extends SyntacticElement.Impl implements
      NonUnion {

    public final UnresolvedType key;
    public final UnresolvedType value;

    public Dictionary(UnresolvedType key, UnresolvedType value,
