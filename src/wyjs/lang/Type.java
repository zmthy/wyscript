...
public abstract class Type {
  ...
  public static Fun T_FUN(ProcessName receiver, Type ret,
  ...
  public static Type renameRecursiveTypes(Type t, Map<NameID, NameID> binding) {
    if (t instanceof Existential || t instanceof Void || t instanceof Null
      ...
      for (Map.Entry<String, Type> b : tt.types.entrySet()) {
        fields.put(b.getKey(), renameRecursiveTypes(b.getValue(), binding));
      }
      ...
      if (lt.type != null) {
        return T_RECURSIVE(name, renameRecursiveTypes(lt.type, binding));
      } else {
  ...
  public static Type
    ...
    if (t instanceof Existential || t instanceof Void || t instanceof Null
      ...
      HashMap<String, Type> fields = new HashMap<String, Type>();
      for (Map.Entry<String, Type> b : tt.types.entrySet()) {
        fields.put(b.getKey(), substituteRecursiveTypes(b.getValue(), binding));
      }
      return T_RECORD(fields);
    } else if (t instanceof Recursive) {
      Recursive lt = (Recursive) t;
      ...
      if (lt.type != null) {
        return T_RECURSIVE(lt.name, substituteRecursiveTypes(lt.type, binding));
      } else {
  ...
  public static Type unfactor(Type.Recursive type) {
    if (type.type instanceof Union) {
      ...
      binding.put(type.name,
          leastUpperBound(factors, T_RECURSIVE(type.name, null)));
    ...
    for (Type pt : types) {
      ...
      if (rt == null) {
        ...
        for (Map.Entry<String, Type> ent : rt.types.entrySet()) {
          ...
          if (ttt != null) {
            it.put(ent.getKey(), Type.leastUpperBound(ttt, ent.getValue()));
          }
        }
  ...
  public static class Named extends ProcessName {
    ...
    public boolean equals(Object o) {
      if (o instanceof Named) {
        Named l = (Named) o;
        return type.equals(l.type) && name.equals(l.name);
      }
      return false;
    }
  ...
  public static final class Fun extends NonUnion {
    ...
    public boolean equals(Object o) {
      if (o instanceof Fun) {
        Fun fun = (Fun) o;
        if (receiver == null) {
          return fun.receiver == null && ret.equals(fun.ret)
              && params.equals(fun.params);
        } else {
          return receiver.equals(fun.receiver) && ret.equals(fun.ret)
              && params.equals(fun.params);
        }
      }
      return false;
  ...
  public static String type2str(Type t) {
    if (t == Type.T_EXISTENTIAL) {
      ...
      return "L" + type2str(st.element);
    } else if (t instanceof Type.Set) {
      Type.Set st = (Type.Set) t;
      return "Se" + type2str(st.element);
    } else if (t instanceof Type.Dictionary) {
      Type.Dictionary st = (Type.Dictionary) t;
      return "D" + type2str(st.key) + "t" + type2str(st.value);
    } else if (t instanceof Type.Union) {
